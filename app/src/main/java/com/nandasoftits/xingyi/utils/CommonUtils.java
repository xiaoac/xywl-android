...
public class CommonUtils {
    ...
    public static ColorStateList getRColor(Context context, int rId) {
        Resources resource = (Resources) context.getResources();
        ColorStateList csl = (ColorStateList) resource.getColorStateList(rId);
        return csl;
    }
    ...
    public static int getAndroiodScreenWidth(Context context) {
        ...
        Logger.d(LOG_TAG, "getAndroiodScreenWidth -> " + screenWidth);
    ...
    public static void doCallBackInMainThread(Runnable runnable) {
    ...
    public static boolean isBelowLOLLIPOP() {
        // API< 21
        Logger.d(LOG_TAG, "Build.VERSION.SDK_INT -> " + Build.VERSION.SDK_INT);
