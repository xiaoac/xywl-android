...
public class PushUtils {
    ...
    public static void initTestJPush(Context context) {
        ...
        String userTag = UserSharedPreferences.getMsg(context, UserSharedPreferences.SPHelp.USER_TAG);
        String userGroup = UserSharedPreferences.getMsg(context, UserSharedPreferences.SPHelp.USER_GROUP);
